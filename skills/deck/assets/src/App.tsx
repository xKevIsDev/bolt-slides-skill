...
/* ══════════════════════════════════════════════════════════════════════
   ...
   Don't reskin this file. The whole look is set in src/styles/tokens.css.
   Each top-level child of <Deck> is one slide.
   ══════════════════════════════════════════════════════════════════════ */
    ...
    <Deck>
      ...
      <Slide center nav="Cover" notes="Welcome. Set the tone, then advance.">
        <Reveal>
          ...
          <p className="subhead" style={{ marginTop: 18 }}>Responsive React slides with the Slidev dock you liked. Delete this and build the real deck.</p>
        </Reveal>
      </Slide>

      {/* Statement with a click-build */}
      <Slide center nav="Statement" notes="Hold a beat before revealing the point on click.">
        <h2 className="headline" style={{ fontSize: 'clamp(34px,5.5vw,68px)', marginInline: 'auto' }}>
          One big idea, <span className="accent-text">on click.</span>
        </h2>
        <Build at={1}>
          <p className="subhead" style={{ marginTop: 20 }}>This line appears when you advance — that's a build (press → or space).</p>
        </Build>
      </Slide>
      ...
      <Split
        ...
        body="Text on one side, media bleeding to the screen edge on the other — responsive on any display."
        media={
          <>
      ...
      <StatGrid
        ...
        title="Proof, counted up on entry."
        stats={[
      ...
      {/* CTA */}
      <Slide center nav="Close" notes="Make the ask. Leave contact details up.">
        <Reveal>
